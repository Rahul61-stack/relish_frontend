  ...
  return (
    <div className="container mx-auto px-3 pt-20 w-fit relative group">
      <div className="">
        <Link href="/category">
        <Image
          className="active:transition active:ease-in-out active:duration-500 rounded-3xl"
          src={imgsrc[index]}
          width={1200}
          height={600}
          alt="Image"
      ...
      <div className="md:hidden md:group-hover:block absolute top-[50%] left-5 pt-1 rounded-full px-1 bg-opacity-50 hover:-translate-x-1 transition ease-in-out hover:bg-opacity-100 bg-black">
        <button onClick={prevSlide}>
          <ArrowLeftCircleIcon width={30} height={30} color="white" />
        </button>
      </div>
      <div className="md:hidden md:group-hover:block absolute top-[50%] right-5 pt-1 rounded-full px-1 bg-opacity-50 hover:translate-x-1 transition ease-in-out hover:bg-opacity-100 bg-black">
