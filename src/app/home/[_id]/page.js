      ...
      if (sale) {
        dispatch(
          cartActions.addToCart({
            id: id,
            name: name,
            price: toIndianCurrency(convertToInt(price)),
            imgurl: url,
          }),
        );
      } else {
              ...
              <div className="md:flex md:flex-row flex flex-col">
                ...
                <div className="md:px-10 pt-10 md:pt-20">
                  ...
                  {item.sale ? (
                    <div className="flex justify-center">
                      ...
                      <p className="font-bold text-center text-sm pl-2 md:pl-5 pb-2 md:text-xl">
                        {toIndianCurrency(convertToInt(item.price))} & Free
                        Shipping
                      </p>
                    </div>
                  ) : (
                  ...
                  <div className="md:hidden py-5">
                    <button
                      className="translate-x-36 p-2 bg-slate-200 font-semibold text-black rounded-lg"
                      onClick={() =>
                        cartHandler(
                          item._id,
                          item.name,
